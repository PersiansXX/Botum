...
class FuturesTestBot:
    ...
    def setup_exchange(self):
        ...
        try:
            ...
            # Margin mode'u isolated olarak ayarla
            try:
                ...
                if 'Unknown parameter' not in str(e):  # Bu hata zaten isolated mode'da olduğunu gösterir
    ...
    def calculate_position_size(self, symbol):
        ...
        try:
            ...
            # Notional value = position_size * current_price >= 5 USDT
            position_size = (min_notional * 1.1) / current_price  # %10 margin ekle
